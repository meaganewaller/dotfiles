...
<pre align="center">
╔════════════════ °❀•°✮°•❀° ═════════════════╗<br>
✧･ﾟ:* <a href="#dotfiles--setup">Setup</a> ✧ <a href="#dotfiles--keybinds">Keybinds</a> ✧ <a href="https://github.com/meaganewaller/dotfiles/wiki/Gallery">Gallery</a> ✧ <a href="https://github.com/meaganewaller/dotfiles/wiki/Guides">Guides</a> *:･ﾟ✧ <br>
╚════════════════ °❀•°✮°•❀° ═════════════════╝
</pre>
 ...
 * **Automation Tool**: [hammersppon](https://github.com/Hammerspoon/hammerspoon) ([config](/wm/hammerspoon))
 ...
 * **Keyboard Customizer**: [Karabiner](https://karabiner-elements.pqrs.org/) ([config](/keyword/karabiner))
 * **Menubar**: [Sketchybar](https://felixkratz.github.io/SketchyBar/config/bar) ([config](/menubar/sketchybar))
...
> It's probably best that you dig into the configs yourself. It's actually like probably not the best habit to install mine (A Stranger's) shell scripts. But also, you do you. 


## <samp>✨TOOLS</samp>
These tools are the one true way[^1].
...
[^1]: Subject to change at any time a new shiny tool catches my eye.
## Credits
