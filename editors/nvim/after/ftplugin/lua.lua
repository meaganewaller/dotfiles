...
local function open_help(tag) meg.wrap_err(vim.cmd.help, tag) end
...
-- meg.ftplugin_conf("nvim-surround", function(surround)
...
local ok_ms, ms = meg.require("mini.surround")
local ok_mai, mai = meg.require("mini.surround")
