...
vim.cmd(string.format("hi matchURL guifg=%s", require("meg.lush_theme.colors").bright_blue))

meg.nmap("<localleader>p", "<Plug>MarkdownPreviewToggle", { buffer = 0, silent = true })
-- REF: https://github.com/ekickx/clipboard-image.nvim/discussions/15
meg.augroup("BlogPostImages", {
  {
    event = { "BufReadPre" },
...
--
-- local cmp_ok, cmp = meg.require("nvim-cmp")
-- if cmp_ok then
...
-- end
--
-- local ms_ok, ms = meg.require("mini.surround")
-- if ms_ok then
