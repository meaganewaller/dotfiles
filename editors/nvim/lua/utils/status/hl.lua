...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("utils.status").hl.mode },
...
-- @usage local heirline_component = require("heirline.utils").surround({ "|", "|" }, require("utils.status").hl.mode_bg, heirline_component),
...
-- @usage local heirline_component = { provider = require("utils.status").provider.fileicon(), hl = require("utils.status").hl.filetype_color },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("utils.status").hl.get_attributes("treesitter") },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("utils.status").hl.file_icon("winbar") },
