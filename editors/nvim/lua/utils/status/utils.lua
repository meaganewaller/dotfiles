...
-- @usage local string = require("utils.status").utils.stylize("Hello", { padding = { left = 1, right = 1 }, icon = { kind = "String" } })
...
-- @usage local heirline_component = { on_click = { callback = function(...) local args = require("utils.status").utils.statuscolumn_clickargs(...) end } }
