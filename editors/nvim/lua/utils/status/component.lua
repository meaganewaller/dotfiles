...
-- @usage local heirline_component = require("utils.status").component.fill()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.file_info()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.file_encoding()
...
---                   file_modified, file_read_only, and the overall padding.
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.tabline_file_info()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.nav()
function M.nav(opts)
  opts = extend_tbl({
    ruler = {},
...
---                   and the overall padding.
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.cmd_info()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.mode { mode_text = true }
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.breadcumbs()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.separated_path()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.git_branch()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.git_diff()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.diagnostics()
...
---@param opts? table options for configuring diagnostic providers and the overall padding.
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.treesitter()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.lsp()
function M.lsp(opts)
  opts = extend_tbl({
    lsp_progress = {
      str = "",
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.foldcolumn()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.numbercolumn()
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.signcolumn()
...
--- A general function to build a section of BrioVim status providers with highlights,
--- conditions, and section surrounding.
---@param opts? table a list of components to build into a section.
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").components.builder({ { provider = "file_icon", opts = { padding = { right = 1 } } }, { provider = "filename" } })
...
---@return table # The Heirline component table.
-- @usage local heirline_component = require("utils.status").component.compiler_state()
