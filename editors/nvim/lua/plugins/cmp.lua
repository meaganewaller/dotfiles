...
local source_mapping = {
  npm = BrioVim.icons.terminal .. "NPM",
  cmp_tabnine = BrioVim.icons.light,
  Copilot = BrioVim.icons.copilot,
  Codeium = BrioVim.icons.codeium,
  nvim_lsp = BrioVim.icons.stack .. "LSP",
  buffer = BrioVim.icons.buffer .. "BUF",
  nvim_lua = BrioVim.icons.bomb,
  luasnip = BrioVim.icons.snippet .. "SNP",
  calc = BrioVim.icons.calculator,
  path = BrioVim.icons.folderOpen2,
  treesitter = BrioVim.icons.tree,
  zsh = BrioVim.icons.terminal .. "ZSH",
}
...
cmp.setup({
  ...
  mapping = cmp.mapping.preset.insert({
    ...
    ["<CR>"] = cmp.mapping.confirm({
      ...
      select = BrioVim.plugins.completion.select_first_on_enter,
    }),
...
-- │ Tabnine Setup                                            │
-- ╰──────────────────────────────────────────────────────────╯
if BrioVim.plugins.ai.tabnine.enabled then
  tabnine:setup({
    max_lines = 1000,
    max_num_results = 3,
    sort = true,
