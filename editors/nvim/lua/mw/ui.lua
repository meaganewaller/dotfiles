...
mw.ui.lsp = {
  colors = {
    error = mw.ui.palette.pale_red,
    warn = mw.ui.palette.dark_orange,
    hint = mw.ui.palette.bright_blue,
    info = mw.ui.palette.teal,
  },
...
---Get the mw.ui setting for a particular filetype
...
function mw.ui.decorations.get(opts)
...
function mw.ui.decorations.set_colorcolumn(bufnr, fn)
  local buf = vim.bo[bufnr]
  local decor = mw.ui.decorations.get({ ft = buf.ft, bt = buf.bt, setting = 'colorcolumn' })
...
----------------------------------------------------------------------------------------------------
mw.ui.current = { border = mw.ui.border.line }
