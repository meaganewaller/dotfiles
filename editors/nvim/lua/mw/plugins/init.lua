...
local border, highlight, icons = mw.ui.current.border, mw.highlight, mw.ui.icons
...
return {
      ...
      dependencies = {
        'mason.nvim',
        {
          ...
          config = function()
            ...
            require('lspconfig').ccls.setup(require('mw.servers')('ccls'))
          end,
        },
      },
      opts = {
        ...
        handlers = {
          function(name)
            local config = require('mw.servers')(name)
  ...
  },
  {
    ...
    config = function()
      ...
      mw.command('TodoDots', ('TodoQuickFix cwd=%s keywords=TODO,FIXME'):format(vim.g.vim_dir))
    end,
  },
  {
