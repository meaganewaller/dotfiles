...
return {
    ...
    opts = {
      override = function(root_dir, library)
        for _, briovim_config in ipairs(BrioVim.supported_configs) do
          if root_dir:match(briovim_config) then
  ...
  --  https://github.com/williamboman/mason.nvim
  {
    ...
    config = function(_, opts)
      ...
      cmd("MasonUpdate", function(options) require("utils.mason").update(options.fargs) end, {
      nargs = "*",
  ...
  --  https://github.com/neovim/nvim-lspconfig
  {
    ...
    config = function(_, _)
      ...
      vim.lsp.handlers["$/progress"] = function(_, msg, info)
        local progress, id = BrioVim.lsp.progress, ("%s.%s"):format(info.client_id, msg.token)
    ...
    opts = function()
      ...
      return {
        ...
        formatting = {
          ...
          format = lspkind_status_ok and lspkind.cmp_format(BrioVim.lspkind)
            or nil,
        },
        snippet = {
