return {
  ...
  },
  {
    ...
    config = function()
      ...
      local config = require("plugins.alpha").config
      alpha.setup(config)
    end
  },
  ...
  -- Completion
  {
    ...
    dependencies = {
      ...
      {
        cond = BrioVim.plugins.ai.tabnine.enabled,
        "tzachar/cmp-tabnine",
        build = "./install.sh",
      },
      {
      ...
      },
      {
        ...
        cond = BrioVim.plugins.ai.copilot.enabled,
        config = function()
  ...
  },
  {
    ...
    cond = BrioVim.plugins.zen.enabled,
  },
  {
    "folke/twilight.nvim",
    config = true,
  ...
  },
  {
    ...
    event = "VeryLazy",
    config = function()
      vim.g.rooter_patterns = BrioVim.plugins.rooter.patterns
  ...
  {
    "folke/noice.nvim",
    cond = BrioVim.plugins.experimental_noice.enabled,
    lazy = false,
    config = function()
  ...
  },
  {
    ...
    cond = BrioVim.plugins.jump_by_subwords.enabled,
    lazy = true,
    keys = { "w", "e", "b", "ge" },
    config = function()
  ...
  -- AI
  {
    ...
    cond = BrioVim.plugins.ai.codeium.enabled,
    event = "InsertEnter",
    cmd = "Codeium",
    dependencies = {
      "nvim-lua/plenary.nvim",
  ...
  {
    "Bryley/neoai.nvim",
    cond = BrioVim.plugins.ai.chatgpt.enabled,
    dependencies = {
