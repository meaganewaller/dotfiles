...
vim.keymap.set('n', '<Leader>rb', function() require('reach').buffers(buffersOptions) end, { noremap = true, silent = true, desc = 'Buffers' })
vim.keymap.set('n', '<Leader>rm', function() require('reach').marks(marksOptions) end, { noremap = true, silent = true, desc = 'Marks' })
