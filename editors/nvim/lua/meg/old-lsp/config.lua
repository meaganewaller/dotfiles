...
local function on_attach(client, bufnr)
  ...
  if client.supports_method("textDocument/documentSymbol") then
    require("meg.lsp.plugins.nvim-navic").setup(client, bufnr)
  end
...
function M.setup(icons, border, root_files, servers)
  ...
  require("meg.lsp.plugins.mason").setup(icons, border)
  require("meg.lsp.plugins.mason.lspconfig").setup()

  setup_language_servers(lspconfig, servers, root_files)

  require("meg.lsp.plugins.null-ls").setup(border, root_files)
end
