...
local disabled_workspaces = meg.format_disabled_dirs
local format_on_save = meg.format_on_save
local server_formatting_block_list = meg.server_formatting_block_list

vim.api.nvim_create_user_command("FormatToggle", function()
	M.toggle_format_on_save()
end, {})

local block_list = meg.formatter_block_list
