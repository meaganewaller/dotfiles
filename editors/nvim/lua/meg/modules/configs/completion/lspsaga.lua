return function()
	require("meg.modules.utils").gen_lspkind_hl()

	local icons = {
		cmp = require("meg.modules.utils.icons").get("cmp", true),
		diagnostics = require("meg.modules.utils.icons").get("diagnostics", true),
		kind = require("meg.modules.utils.icons").get("kind", true),
		type = require("meg.modules.utils.icons").get("type", true),
		ui = require("meg.modules.utils.icons").get("ui", true),
	}
	...
	require("lspsaga").setup({
		...
		hover = {
			open_link = "gl",
			open_browser = "silent !" .. meg.external_browser,
		},
		outline = {
			win_position = "right",
