return function()
	...
	local colors = require("meg.modules.utils").get_palette()
	local icons = { ui = require("meg.modules.utils.icons").get("ui") }
	...
	local match_hl = require("meg.modules.utils").hl_to_rgb("String", false, colors.green)
