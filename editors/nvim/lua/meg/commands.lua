...
return legendary.commands({
  {
    ":LineNumbers",
    function() mw.ToggleLineNumbers() end,
    description = "Toggle line numbers",
  },
  {
    ":ChangeFiletype",
    function() mw.ChangeFiletype() end,
  ...
  {
    "Lazygit",
    function() mw.float_term("lazygit", { size = { width = 1, height = 1 } }) end,
  ...
  {
    ":Snippets",
    function() mw.EditSnippet() end,
    description = "Edit Snippets",
  },
  {
    ":Theme",
    function() mw.ToggleTheme() end,
