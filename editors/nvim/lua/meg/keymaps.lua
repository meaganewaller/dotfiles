...
nx.map({
	...
	{ vim.g.eu_kbd and "Ú" or "<A-S-j>", "\"dy']\"dp`]'[V']", "v", desc = "Duplicate Lines Down" },
	{ vim.g.eu_kbd and "Ĳ" or "<A-S-k>", "\"dy\"dP'[V']", "v", desc = "Duplicate Lines Up" },
	-- Add Blank Line, Stay in Normal Mode
	{ vim.g.eu_kbd and "ö" or "<A-o>", 'o<Esc>^"_D', desc = "Add Blank Line Below" },
	{ vim.g.eu_kbd and "Ö" or "<A-O>", 'O<Esc>^"_D', desc = "Add Blank Line Above" },
	-- Indentation
