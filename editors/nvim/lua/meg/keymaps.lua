...
nx.map({
  ...
  {
    "<Leader>bs",
    function() require("silicon").visualise_api({ to_clip = true, show_buf = true }) end,
    desc = "Generate image of whole buffer with highlighted lines",
  },
}, { mode = "v" })
...
nx.map({
  {
    "<Leader><Leader>s",
    function() require("silicon").visualise_api({ to_clip = true, visible = true }) end,
    desc = "Generate visible portion of a buffer",
  },
  {
    "<Leader>bs",
    function() require("silicon").visualise_api({ to_clip = true }) end,
    desc = "Generate hidden portion of a buffer",
  },
})
