...
function M.config()
  ...
  local icons = {
    diagnostics = require("meg.icons").lsp,
    ui = require("meg.icons").misc,
  }
  ...
  nnotify.setup({
    ...
    render = function(bufnr, notif, hls, _cfg)
      ...
      local title = (notif.title and meg.tlen(notif.title) > 0 and notif.title[1] ~= "") and notif.title[1] or "nvim"
