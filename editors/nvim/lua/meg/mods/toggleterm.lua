...
function M.config()
  ...
  tt.setup({
    ...
    on_open = function(term)
      ...
      if not term.opened then
        if require("meg.utils").root_has_file("Deskfile") then term:send("eval $(desk load)") end
      end
  ...
  meg.command("Btop", function() btop:toggle() end)
  meg.command("Iex", function() elixir_iex:toggle() end)
  ...
  --
  -- local has_wk, wk = meg.require("which-key")
