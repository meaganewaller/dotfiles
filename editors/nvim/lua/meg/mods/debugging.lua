...
return {
  {
    ...
    keys = {
      ...
      {
        "<localleader>duc",
        function() require("dapui").close(meg.debug.layout.ft[vim.bo.ft]) end,
        desc = "dap ui: close",
      },
      {
        "<localleader>dut",
        function() require("dapui").toggle(meg.debug.layout.ft[vim.bo.ft]) end,
        desc = "dap ui: toggle",
      },
    ...
    config = function()
      ...
      --   { DapBreakpoint = { fg = meg.ui.palette.light_red } },
      --   { DapStopped = { fg = meg.ui.palette.green } },
      -- })
      ...
      dap.listeners.after.event_initialized["dapui_config"] = function() dapui.open(meg.debug.layout.ft[vim.bo.ft]) end
    end,
    dependencies = {
      {
        {
