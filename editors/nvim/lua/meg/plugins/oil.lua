...
local function find_files()
  ...
  mw.find_files({ cwd = dir, hidden = true })
end
...
nx.map({
  ...
  { "_", function() oil.open(vim.fn.getcwd()) end, desc = "Open cwd" },
})
