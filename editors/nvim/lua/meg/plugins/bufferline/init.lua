...
local style = require("meg.plugins.bufferline.styles.slim-shady") -- slim-shady | slant
...
bufferline.setup({
	options = {
		...
		offsets = {
			{
				-- text = "󰙅 Neo-tree",
				text = function() return "󰙅 " .. require("meg.utils").truc_path(vim.fn.getcwd()) end,
				filetype = "neo-tree",
...
if vim.g.colors_name == "rose-pine" then
	local palette = require("meg.colorschemes.rose-pine").palette
	nx.hl({
		{ "BufferLineIndicatorSelected", link = palette.iris },
		{ "BufferlineOffset", fg = palette.subtle, bg = palette.surface },
	})
else
