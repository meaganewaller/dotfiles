local function setup(trouble, fillchars)
  trouble.setup({
    ...
    fold_open = fillchars.foldopen, -- icon used for open folds
    fold_closed = fillchars.foldclose, -- icon used for closed folds
    ...
    action_keys = { -- key mappings for actions in the trouble list
      ...
      open_split = "o", -- open buffer in new split
...
if not loaded then
  mw.loading_error_msg("trouble.nvim")
  return
end

local fillchars = mw.ui.icons.fillchars.global
setup(trouble, fillchars)
