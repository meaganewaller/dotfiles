...
nx.map({
  ...
  { "<Leader>/faf", "<cmd>Telescope find_files find_command=fd,--hidden,--no-ignore-vcs<CR>", desc = "Find all files" },
  { "<Leader>/G", "<cmd>Telescope live_grep<CR>", desc = "Live grep" },
  { "<Leader>/h", "<cmd>Telescope help_tags<CR>", desc = "Help" },
  { "<Leader>/m", "<cmd>Telescope marks<CR>", desc = "Marks" },
  { "<Leader>/r", "<cmd>Telescope resume<CR>", desc = "Resume" },
  { "<Leader>/s", "<cmd>Telescope grep_string<CR>", desc = "Search" },
  { "<Leader>/t", "<cmd>Telescope treesitter<CR>", desc = "Treesitter" },
  { "<Leader>/T", "<cmd>Telescope tags<CR>", desc = "Tags" },
  { "<Leader>/w", "<cmd>Telescope grep_string<CR>", desc = "Search" },
  { "<Leader>/y", "<cmd>Telescope registers<CR>", desc = "Registers" },
  { "<Leader>/z", "<cmd>Telescope spell_suggest<CR>", desc = "Spell Suggest" },
  { "<Leader>/q", "<cmd>Telescope quickfix<CR>", desc = "Quickfix" },
  { "<Leader>/Q", "<cmd>Telescope quickfixhistory<CR>", desc = "Quickfix History" },
  { "<Leader>/S", "<cmd>Telescope search_history<CR>", desc = "Search History" },
  { "<Leader>/a", "<cmd>Telescope autocommands<CR>", desc = "Autocommands" },
...
--     },
--     media_files = {
--       filetypes = { "png", "webp", "jpg", "jpeg", "mp4", "pdf", "svg", "webm" },
--       find_cmd = "rg",
--     },
--     recent_files = {
--       only_cwd = true,
...
--
-- nx.map({
--   { "<Leader>p", "<cmd>lua require('telescope.builtin').find_files({ find_command = { 'fd', '-t=f', '-H' }})<CR>", desc = "Search files" },
--   { "<Leader>/g", "<cmd>Telescope live_grep_args<CR>", desc= "Search in files" },
--   { "<Leader>r", "<cmd>lua require('telescope').extensions.recent_files.pick({ only_cwd = true })<CR>", desc = 'Recent files' },
--   { "<Leader>b", "<cmd>Telescope buffers<CR>", desc = "Opened buffers" },
--   -- -- Quick Pickers
--   -- {
--   --   "<C-p>",
--   --   function()
...
--  --  -- Config
--  --  --[[ {"<leader>,/"},
-- 	-- "<Cmd>Telescope file_browser depth=false path=~/.config/nvim grouped=true prompt_title=megvim\\ Config<CR>",
-- 	--  desc = "Search Config Files" ) ]]
--  --  -- { "<leader>,k", function() find_config("Keymaps", nil, "keymaps") end, desc = "Search Keymap Files" },
--  --  {
--  --    "<leader>,k",
--  --    "<Cmd>Telescope grep_string cwd=~/.config/nvim/lua/meg/ search=nx.map prompt_title=megvim\\ Keymaps<CR>",
