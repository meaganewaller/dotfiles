...
require("meg.quick_action").add("menu", {
  name = "Pick color",
  condition = function()
    local has_ccc, cccconfig = pcall(require, "ccc.config")
    if not has_ccc then return false end
    local pickers = cccconfig.get("pickers")
