...
nx.map({
  ...
  { "mhb", function() harpoon_ui.nav_next() end, desc = "Harpoon Next" },
  { "mhc", function() harpoon_ui.nav_prev() end, desc = "Harpoon Prev" },
  { "mhd", function() harpoon_ui.nav_delete() end, desc = "Harpoon Delete" },
