...
local function on_attach(client, bufnr)
  ...
  if client.supports_method("textDocument/documentSymbol") then
    require("meg.plugins.lsp.navic").setup(client, bufnr)
  end
...
require("meg.plugins.lsp.mason").setup(icons, border)
require("meg.plugins.lsp.mason.config").setup()

setup_language_servers(lspconfig, servers, root_files)

require("meg.plugins.lsp.null-ls").setup(border, root_files)
