...
local function set_term_opts()
  ...
  pcall(vim.api.nvim_buf_set_option, term_buf_id, "filetype", "megterm")
...
local function set_keymaps()
  ...
  meg.tmap("<esc>", [[<C-\><C-n>]], keymap_opts)
  -- TODO: :h wincmd; TL;DR - winnr .. wincmd w
  -- meg.tmap("<C-h>", fmt([[<Cmd>%swincmd w<CR>]], term.caller_winnr), keymap_opts)
  -- meg.tmap("<C-j>", fmt([[<Cmd>%swincmd w<CR>]], term.caller_winnr), keymap_opts)
  -- meg.tmap("<C-k>", fmt([[<Cmd>%swincmd w<CR>]], term.caller_winnr), keymap_opts)
  -- meg.tmap("<C-l>", fmt([[<Cmd>%swincmd w<CR>]], term.caller_winnr), keymap_opts)
...
meg.term.open = new_or_open_term
...
-- [COMMANDS] ------------------------------------------------------------------
meg.command("T", function(opts) meg.term.toggle(opts.args) end, { nargs = "*" })
meg.command("TSendCurrentLine", function(args) send_lines_to_terminal("single_line", true, args) end, { nargs = "?" })
meg.command(
  "TSendVisualLines",
