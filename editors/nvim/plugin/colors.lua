...
local function general_overrides()
  highlight.all({
    ...
    { RainbowDelimiterRed = { fg = P.red, bg = "bg" } },
    { RainbowDelimiterOrange = { fg = P.orange, bg = "bg" } },
    { RainbowDelimiterGreen = { fg = P.green, bg = "bg" } },
    { RainbowDelimiterViolet = { fg = P.magenta, bg = "bg" } },
    { RainbowDelimiterYellow = { fg = P.bright_yellow, bg = "bg" } },
    { RainbowDelimiterBlue = { fg = P.blue, bg = "bg" } },
    { RainbowDelimiterCyan = { fg = P.teal, bg = "bg" } },
