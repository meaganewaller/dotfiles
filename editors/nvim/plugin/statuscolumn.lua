if not mw or not mw.ui.statuscolumn.enable then return end
...
local ui, sep, falsy = mw.ui, mw.ui.icons.separators, mw.falsy
...
local function extmark_signs(curbuf, lnum)
  ...
  local sns = mw.fold(function(acc, item)
...
opt.statuscolumn = '%{%v:lua.mw.ui.statuscolumn.render()%}'
