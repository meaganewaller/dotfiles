...
local function setup_keymaps(client, bufnr)
  ...
  nnoremap("gn", require("meg.lsp.rename").rename, desc("lsp: rename"))
...
local function on_attach(client, bufnr)
  ...
  if type(caps.provider) == "boolean" and caps.colorProvider then
    if client.name == "tailwindcss" then
      -- require("meg.document_colors").buf_attach(bufnr, { single_column = true, col_count = 2 })
  ...
  -- if caps.signatureHelpProvider then require("meg.lsp.signature").setup(client) end
...
local servers = require("meg.servers")
...
local function get_server_capabilities()
  ...
  local nvim_lsp_ok, cmp_nvim_lsp = meg.pcall(require, "cmp_nvim_lsp")
