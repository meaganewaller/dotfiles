if not mw or not mw.ui.statusline.enable then return end
...
local icons, lsp, highlight, decorations = mw.ui.icons, mw.ui.lsp, mw.highlight, mw.ui.decorations
local api, fn, fs, fmt, strwidth = vim.api, vim.fn, vim.fs, string.format, vim.api.nvim_strwidth
local P, falsy = mw.ui.palette, mw.falsy
...
local function diagnostic_info(context)
  ...
  local lsp_icons = mw.ui.icons.lsp
  local result = {
...
function mw.ui.statusline.lsp_client_click()
...
---@return string
function mw.ui.statusline.render()
  ...
  lsp_clients[1].click = 'v:lua.mw.ui.statusline.lsp_client_click'
  -----------------------------------------------------------------------------//
  -- Left section
  -----------------------------------------------------------------------------//
...
-- set the statusline
vim.o.statusline = '%{%v:lua.mw.ui.statusline.render()%}'
