...
- Map tool → ecosystem:
  ...
  - **Scripted CLIs used by install** → `home/dot_config/versions/cli-versions.toml`
...
**Request**: "Add cosign and make installer use a fixed version" → **Action**: Add to `cli-versions.toml` and confirm install reads it.
