...
./install -- --force          # Force overwrite existing files
...
- **Preference**: Install tools through package managers when they are stable and unlikely to diverge in version across projects (e.g., neovim, lazygit, ripgrep, fd, fzf)
...
4. Use commit prefixes: `feat:` for new features/packages, `fix:` for corrections, `chore:` for maintenance, `doc:` for documentation updates, `refactor:` for refactorings
